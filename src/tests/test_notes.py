...
def test_create_note(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes, "post_note", mock_post)
...
def test_read_all_notes(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes, "get_all_notes", mock_get_all)
...
def test_update_note(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes, "get_note", mock_get)

    async def mock_put(id, payload):
        return 1

    monkeypatch.setattr(notes, "put_note", mock_put)
...
def test_remove_note(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes, "delete_note", mock_delete)
